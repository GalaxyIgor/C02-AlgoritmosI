...
int buscar(info tabela_hash[], int m, int k){
	...
	while(i<m){
		hk = hash_quadratico(k,m,i);
		if(tabela_hash[hk].k == k && tabela_hash[hk].status != -2){
			return hk;
		}
		else
			i++;
...
int main(){
	...
	cout << "Posição do número 54: " << buscar(tabela_hash, m, 37) << endl;
...
depois da inserção dos números 65, 45, 8, 78, 54 e 14, remoção dos número 45 e 65, o valor retornado da busca pelo número 54 retorna:
=========================================================================================================================================*/