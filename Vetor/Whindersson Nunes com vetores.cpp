...
int main()//funcao
{
	...
	int visualizacoes[1000];//declarcao do numero de visualizacoes de um video, long para aumentar os bits
	...
	for ( i = 0; i < Repeticoes; i++)//repeticao correspondente ao numero de repeticoes
	{
